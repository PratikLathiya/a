...
<section class="info-area">
	...
	<section class="">
		<div class=""  style="height:400px;background-image: url('assets/images/banners/1599829597lady with flower.jpg');">
				<div class="row" >
						...
						<div class="col-lg-6" >
							...
							<br>
							<button type="button" class="btn btn-outline-light">Discover More</button>
						</div>
						</div>
	...
	<div id="card" style="padding: 80px">
		<div class="row">
			<div class="col-lg-6" style="height:400px;text-align: center;background-image: url('assets/images/1599886325newsletter.jpg')">
				<h2 style="color: white;">ALL EARTHY HAIR <br>CARE PRODUCTS</h2>
				<br><br>
				...
				<br><br>
				<button type="button" class="btn btn-outline-light">Check More</button>
			</div>
			<div style="background-image: url('assets/images/blog.jpeg');height: 400px;width:609px;padding:86px 141px">
...
<section>
	<div style="background-image: url('assets/images/BlogSection.png') ;padding:100px"  >
		<center><h2>LATEST BLOG</h2></center>
		...
		<div class="row">
			<div class="col-lg-6" style="height:400px;background-image: url('assets/images/1599886325newsletter.jpg')">
				<div style="padding:80px;">
					...
					<button type="button" class="btn btn-outline-light">Submit Now</button><br><br>
				</div>
			</div>
			<div class="col-lg-6" style="height: 400px;width:675px;">
