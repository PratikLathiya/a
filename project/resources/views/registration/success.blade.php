...
background-image:url({{url('assets/jpg/vendorlogin8.jpg')}});
...
<body id="body">
   <div class="progress">
	...
	<div class="padding text-center" style="">
		...
		<a href="{{route('front.index')}}" style="color: white;"><button class="btn btn-success"  onclick="closeForm()">Home</button></a>
