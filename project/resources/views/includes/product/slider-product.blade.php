                                ...
                                @if($prod->user->is_vendor == 2)
										...
										<a href="{{ route('front.product', $prod->slug) }}" class="item">
											<div class="item-img">
												...
												<img class="img-fluid " id="featured" href="{{ route('product.cart.quickadd',$prod->id) }}" src="{{ $prod->thumbnail ? asset('assets/images/thumbnails/'.$prod->thumbnail):asset('assets/images/noimage.png') }}" alt="">
											</div>
											<div class="info">
												<div class="stars">
                                                  <div class="ratings">
