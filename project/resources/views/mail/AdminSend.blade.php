...
<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" class="full">
  ...
  <tr>
    <td>
        ...
        <tr><td class="heightsmalldevices" height="60">&nbsp;</td></tr>
  <tr>
    <td style="font:400 16px 'Montserrat', Helvetica, Arial, sans-serif; color:#4a4a4a; text-transform:uppercase;">Congratulations, One new user is registered here</td>
  </tr>
  <tr><td class="heightsmalldevices" height="30">&nbsp;</td></tr>
  <tr>
  	<td>
    	<table width="100%" align="center" border="0" cellspacing="0" cellpadding="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt; text-align:center;">
  <tr>
    <td width="55">&nbsp;</td>
    <td height="22">&nbsp;</td>
    <td width="55">&nbsp;</td>
  ...
  <tr>
    <td width="55">&nbsp;</td>
    <td style="font:14px Helvetica, Arial, sans-serif; color:#787878;">
      <p class="subtitle">Name : {{  $vendor->customer_name }}</p>
      <p class="subtitle">Email  :  {{  $vendor->customer_email }}</p>
      <p class="subtitle">Phone number :  {{  $vendor->customer_number }}</p>
    </td>
    <td width="55">&nbsp;</td>
  </tr>
   <tr>
