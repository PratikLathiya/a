...
Route::prefix('admin')->group(function() {
  ...
  Route::get('/vendors-list', 'Admin\VendorController@vendorlist')->name('admin-vendor-list');
  //vendor detail page
  Route::get('/vendor/{id}/detail', 'Admin\VendorController@vendorDetail')->name('admin-vendor-detail');
  //send email to user
  Route::get('/send/{email}/mail/', 'Admin\VendorController@sendEmail')->name('send.email.user');
  
//   Route::get('/vendors-list/datatables', 'Admin\VendorController@vendor_list_datatables')->name('admin-vendor-list-datatables');
